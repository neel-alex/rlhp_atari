...
class SACPolicy(BasePolicy):
    ...
    def __init__(
        ...
        self.activation_fn = activation_fn
        actor_net_arch = \
            self.net_arch if type(self.net_arch) is list else self.net_arch['pi']
        critic_net_arch = \
            self.net_arch if type(self.net_arch) is list else self.net_arch['qf']
        self.net_args = {
        ...
        self.actor_kwargs.update({"net_arch": actor_net_arch})
