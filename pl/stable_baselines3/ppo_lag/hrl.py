...
class HRL(OnPolicyAlgorithm):
    """
    Implements a hierarchcial reinforcement learning algorithm which makes use of
    demonstrations from possible agents with different dynamics and/or embodiments.
    ...
    def __init__(
        ...
        # TODO: Add this to init arguments
        self.demos = expert_demonstrations
    ...
    def train(self) -> None:
        """
        Updates both the policy_high and policy_low using the data thus gathered so far.
        """
        # Update optimizer learning rate
        self._update_learning_rate(self.policy_low.optimizer)
        ...
        # =====================================================
        # Train the higher level policy
        # =====================================================
        for epoch in range(self.n_epochs_high):
            for rollout_data in self.rollout_buffer_high.get(self.batch_size_high):
                reward_values, log_prob, entropy = self.policy_high.evaluate_actions(rollout_data.opbservations, actions)
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                reward_values, log_prob, entropy = self.policy.evaluate_actions(rollout_data.observations, actions)
