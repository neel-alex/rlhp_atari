...
from stable_baselines3.common.buffers import ReplayBuffer, ReplayBufferWithRM
...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def _setup_model(self) -> None:
        ...
        if self.reward_model is not None:
            self.replay_buffer = ReplayBufferWithRM(
                self.reward_model,
                self.reward_relabeling,
                self.buffer_size,
    ...
    def _dump_logs(self) -> None:
        ...
        logger.record("time/time_elapsed (h) ", int(time.time() - self.start_time)/3600, exclude="tensorboard")
